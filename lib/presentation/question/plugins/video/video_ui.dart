        ...
        () => controller.isLoading == true
            ...
            : Stack(
                children: [
                  ...
                  Obx(
                    () => controller.isChooseLanguage == true
                        ? Positioned(
                            right: 0.05 * size.width,
                            top: 0.025 * size.height,
                            child: Container(
                              // height: 0.3 * size.height,
                              width: 0.175 * size.width,
                              decoration: const BoxDecoration(
                                image: DecorationImage(
                                  image:
                                      AssetImage(LocalImage.languageOptionBox),
                                  fit: BoxFit.fill,
                                ),
                              ),
                              child: Column(
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        controller.languague == 'vi'
                                            ? Image(
                                                image: const AssetImage(
                                                    LocalImage.choosedLanguage),
                                  ...
                                  if (controller.isHasVideoMong)
                                    GestureDetector(
                                      onTap: () {
                                        controller.onChangeLanguage('mo');
                                      },
                                      child: Row(
                                        children: [
                                          SizedBox(
                      ...
                      child: Align(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(LocalImage.languageBox),
                                    fit: BoxFit.fill,
                                  ),
                                ),
                                child: Row(
                                  children: [
                                    ...
                                    Image(
                                      image:
                                          const AssetImage(LocalImage.dropDown),
                                      width: size.width * 0.015,
                                      height: size.width * 0.015,
                                    )
                                  ],
