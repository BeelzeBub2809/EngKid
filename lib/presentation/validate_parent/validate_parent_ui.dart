...
import 'validate_parent_controller.dart';

class ValidateParentScreen extends GetView<ValidateParentController> {
  const ValidateParentScreen({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Obx(
                          () => controller.fillIndex == 3 &&
                                  controller.initialParentCode[3] != ""
                              ? ImageText(
                                  text: 'confirm',
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            ...
                            child: RegularText('cancel'.tr, style: TextStyle(fontSize: Fontsize.normal, color: AppColor.red),))
                      ],
                    ),
                  ))
            ],
