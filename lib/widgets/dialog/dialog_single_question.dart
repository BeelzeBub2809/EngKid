...
enum TypeSingleDialog { warning, failed, success }

class DialogSingleQuestion extends StatelessWidget {
  const DialogSingleQuestion({
    super.key,
    required this.type,
